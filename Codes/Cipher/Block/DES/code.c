...
void gen_round_keys(uint64_t key, uint64_t * roundkeys);


/* ********************* MODE OF OPERATIONS PROTOTYPE ********************* */
/** Electronic Code Book mode **/
void des_encrypt_ecb(uint8_t * data, uint32_t length, uint8_t * key);
void des_decrypt_ecb(uint8_t * data, uint32_t length, uint8_t * key);

/** Cipher Block Chaining mode **/
void des_encrypt_cbc(uint8_t * data, uint32_t length, uint8_t * key, uint8_t * iv);
void des_decrypt_cbc(uint8_t * data, uint32_t length, uint8_t * key, uint8_t * iv);

/** Cipher Feedback mode **/
void des_encrypt_cfb(uint8_t * data, uint32_t length, uint8_t * key, uint8_t * iv);
void des_decrypt_cfb(uint8_t * data, uint32_t length, uint8_t * key, uint8_t * iv);

/** Counter mode **/
void des_encrypt_ctr(uint8_t * data, uint32_t length, uint8_t * key, uint8_t *nonce);
void des_decrypt_ctr(uint8_t * data, uint32_t length, uint8_t * key, uint8_t *nonce);

/** Output Feedback mode **/
void des_encrypt_ofb(uint8_t * data, uint32_t length, uint8_t * key, uint8_t * iv);
void des_decrypt_ofb(uint8_t * data, uint32_t length, uint8_t * key, uint8_t * iv);

/** Propagating Cipher Block Chaining mode **/
void des_encrypt_pcbc(uint8_t * data, uint32_t length, uint8_t * key, uint8_t * iv);
void des_decrypt_pcbc(uint8_t * data, uint32_t length, uint8_t * key, uint8_t * iv);
...
*/
void 
des_encrypt_ecb(uint8_t * data, uint32_t length, uint8_t * key)
{
    uint32_t i;
    des_t    config;
...
*/
void 
des_decrypt_ecb(uint8_t * data, uint32_t length, uint8_t * key)
{
    uint32_t i;
    des_t    config;
...
*/
void 
des_encrypt_cbc(uint8_t * data, uint32_t length, uint8_t * key, uint8_t * iv)
{
    uint32_t   i;
...
*/
void 
des_decrypt_cbc(uint8_t * data, uint32_t length, uint8_t * key, uint8_t * iv)
{
    uint32_t   i;
    des_t      config;
...
*/
void 
des_encrypt_cfb(uint8_t * data, uint32_t length, uint8_t * key, uint8_t * iv)
{
    uint32_t   i;
    uint8_t    prev_block[BLOCKSIZEB];
    des_t      config;
...
*/
void 
des_decrypt_cfb(uint8_t * data, uint32_t length, uint8_t * key, uint8_t * iv)
{
    uint32_t   i;
    uint8_t    prev_block[BLOCKSIZEB];
    uint8_t    ctext_block[BLOCKSIZEB];
...
*/
void 
des_encrypt_ctr(uint8_t * data, uint32_t length, uint8_t * key, uint8_t *nonce)
{
    uint32_t   i;
...
*/
void 
des_decrypt_ctr(uint8_t * data, uint32_t length, uint8_t * key, uint8_t *nonce)
{
    uint32_t   i;
    uint8_t    local_nonce[BLOCKSIZEB];
    uint32_t * nonce_counter = (uint32_t*)&local_nonce[BLOCKSIZEB-4];
...
*/
void 
des_encrypt_ofb(uint8_t * data, uint32_t length, uint8_t * key, uint8_t * iv)
{
    uint32_t   i;
    uint8_t    prev_block[BLOCKSIZEB];
    des_t      config;
...
*/
void 
des_decrypt_ofb(uint8_t * data, uint32_t length, uint8_t * key, uint8_t * iv)
{
    uint32_t   i;
    uint8_t    prev_block[BLOCKSIZEB];
    des_t      config;
...
*/
void 
des_encrypt_pcbc(uint8_t * data, uint32_t length, uint8_t * key, uint8_t * iv)
{
    uint32_t   i;
    uint8_t    prev_block[BLOCKSIZEB];
...
*/
void 
des_decrypt_pcbc(uint8_t * data, uint32_t length, uint8_t * key, uint8_t * iv)
{
    uint32_t   i;
    uint8_t    prev_block[BLOCKSIZEB];
    uint8_t    ctext_block[BLOCKSIZEB];
...
int main(int argc, char* argv[])
{
    ...
    */
    ...
    Tiap block berukuran 64-bit (8-byte).
    ...
    */
    ...
    des_encrypt_ecb(encbuffer, 48, key);       // ECB
    // des_encrypt_cbc(encbuffer, 48, key, iv);   // CBC
    // des_encrypt_cfb(encbuffer, 48, key, iv);   // CFB
    // des_encrypt_ctr(encbuffer, 48, key, iv);   // CTR
    // des_encrypt_ofb(encbuffer, 48, key, iv);   // OFB
    // des_encrypt_pcbc(encbuffer, 48, key, iv);  // PCBC
    printx("Encrypted:", encbuffer, 48);

    // Dekripsi - block: 128   key: 256
    memcpy(decbuffer, encbuffer, 48);
    des_decrypt_ecb(decbuffer, 48, key);       // ECB
    // des_decrypt_cbc(decbuffer, 48, key, iv);   // CBC
    // des_decrypt_cfb(decbuffer, 48, key, iv);   // CFB
    // des_decrypt_ctr(decbuffer, 48, key, iv);   // CTR
    // des_decrypt_ofb(decbuffer, 48, key, iv);   // OFB
    // des_decrypt_pcbc(decbuffer, 48, key, iv);  // PCBC
