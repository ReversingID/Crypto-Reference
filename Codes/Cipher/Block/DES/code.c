...
Compile:
    ...
    $ cl /I. main.c mode.c DES/code.c

    (gcc, from Codes/Cipher/Block/)
    $ gcc -I. -o test main.c mode.c DES/code.c

    Modes of operation are in mode.c (not in this file).

Assemble:
    (gcc)
    $ gcc -m32 -S -masm=intel -o DES/code.asm DES/code.c

    (msvc)
    $ cl /c /FaDES/code.asm DES/code.c
*/
#include <stdint.h>
#include <string.h>
