...
void xtea_encrypt_ecb(uint8_t * data, uint32_t length, uint8_t * key);
void xtea_decrypt_ecb(uint8_t * data, uint32_t length, uint8_t * key);

/** Cipher Block Chaining mode **/
void xtea_encrypt_cbc(uint8_t * data, uint32_t length, uint8_t * key, uint8_t * iv);
void xtea_decrypt_cbc(uint8_t * data, uint32_t length, uint8_t * key, uint8_t * iv);

/** Cipher Feedback mode **/
void xtea_encrypt_cfb(uint8_t * data, uint32_t length, uint8_t * key, uint8_t * iv);
void xtea_decrypt_cfb(uint8_t * data, uint32_t length, uint8_t * key, uint8_t * iv);

/** Counter mode **/
void xtea_encrypt_ctr(uint8_t * data, uint32_t length, uint8_t * key, uint8_t * nonce);
void xtea_decrypt_ctr(uint8_t * data, uint32_t length, uint8_t * key, uint8_t * nonce);

/** Output Feedback mode **/
void xtea_encrypt_ofb(uint8_t * data, uint32_t length, uint8_t * key, uint8_t * iv);
void xtea_decrypt_ofb(uint8_t * data, uint32_t length, uint8_t * key, uint8_t * iv);

/** Propagating Cipher Block Chaining mode **/
void xtea_encrypt_pcbc(uint8_t * data, uint32_t length, uint8_t * key, uint8_t * iv);
void xtea_decrypt_pcbc(uint8_t * data, uint32_t length, uint8_t * key, uint8_t * iv);
...
*/
void 
xtea_encrypt_ecb(uint8_t * data, uint32_t length, uint8_t * key)
{
    uint32_t   i;
...
*/
void 
xtea_decrypt_ecb(uint8_t * data, uint32_t length, uint8_t * key)
{
    uint32_t   i;
...
*/
void 
xtea_encrypt_cbc(uint8_t * data, uint32_t length, uint8_t * key, uint8_t * iv)
{
    uint32_t   i;
...
*/
void 
xtea_decrypt_cbc(uint8_t * data, uint32_t length, uint8_t * key, uint8_t * iv)
{
    uint32_t   i;
...
*/
void 
xtea_encrypt_cfb(uint8_t * data, uint32_t length, uint8_t * key, uint8_t * iv)
{
    uint32_t   i;
    uint8_t    prev_block[BLOCKSIZEB];
...
*/
void 
xtea_decrypt_cfb(uint8_t * data, uint32_t length, uint8_t * key, uint8_t * iv)
{
    uint32_t   i;
    uint8_t    prev_block[BLOCKSIZEB];
    uint8_t    ctext_block[BLOCKSIZEB];
...
*/
void 
xtea_encrypt_ctr(uint8_t * data, uint32_t length, uint8_t * key, uint8_t * nonce)
{
    uint32_t   i;
...
*/
void 
xtea_decrypt_ctr(uint8_t * data, uint32_t length, uint8_t * key, uint8_t * nonce)
{
    uint32_t   i;
    uint8_t    local_nonce[BLOCKSIZEB];
    uint32_t * nonce_counter = (uint32_t*)&local_nonce[BLOCKSIZEB-4];
...
*/
void 
xtea_encrypt_ofb(uint8_t * data, uint32_t length, uint8_t * key, uint8_t * iv)
{
    uint32_t   i;
    uint8_t    prev_block[BLOCKSIZEB];
...
*/
void 
xtea_decrypt_ofb(uint8_t * data, uint32_t length, uint8_t * key, uint8_t * iv)
{
    uint32_t   i;
    uint8_t    prev_block[BLOCKSIZEB];
...
*/
void 
xtea_encrypt_pcbc(uint8_t * data, uint32_t length, uint8_t * key, uint8_t * iv)
{
    uint32_t   i;
    uint8_t    prev_block[BLOCKSIZEB];
...
*/
void 
xtea_decrypt_pcbc(uint8_t * data, uint32_t length, uint8_t * key, uint8_t * iv)
{
    uint32_t   i;
    uint8_t    prev_block[BLOCKSIZEB];
    uint8_t    ctext_block[BLOCKSIZEB];
...
int main(int argc, char* argv[])
{
    ...
    */
    ...
    xtea_encrypt_ecb(encbuffer, 64, key);         // ECB
    // xtea_encrypt_cbc(encbuffer, 64, key, iv);     // CBC
    // xtea_encrypt_cfb(encbuffer, 64, key, iv);     // CFB
    // xtea_encrypt_ctr(encbuffer, 64, key, iv);     // CTR
    // xtea_encrypt_ofb(encbuffer, 64, key, iv);     // OFB
    // xtea_encrypt_pcbc(encbuffer, 64, key, iv);    // PCBC
    printx("Encrypted:", encbuffer, 64);

    // Tes Dekripsi -----------------------------------------------------------------
    memcpy(decbuffer, encbuffer, 64);
    xtea_decrypt_ecb(decbuffer, 64, key);         // ECB
    // xtea_decrypt_cbc(decbuffer, 64, key, iv);     // CBC
    // xtea_decrypt_cfb(decbuffer, 64, key, iv);     // CFB
    // xtea_decrypt_ctr(decbuffer, 64, key, iv);     // CTR
    // xtea_decrypt_ofb(decbuffer, 64, key, iv);     // OFB
    // xtea_decrypt_pcbc(decbuffer, 64, key, iv);    // PCBC
